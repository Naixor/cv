...
(function() {
  ...
  var core = {
    ...
    _detectHarris : function(img, params) {
      ...
      case 3:
        kernely = [-1, 0, 1, -2, 0, 2, -1, 0, 1]; // 3*3 kernel
    ...
    _blur : function(data, width, height, radius) {
      ...
      kernel = [0.07511360795411152, 0.12384140315297398, 0.07511360795411152, 0.12384140315297398, 0.2041799555716581, 0.12384140315297398, 0.07511360795411152, 0.12384140315297398, 0.07511360795411152];
